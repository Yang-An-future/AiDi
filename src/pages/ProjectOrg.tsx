        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
          ...
          <div className="lg:col-span-5">
            <div className="bg-[#003366] rounded-[2rem] p-8 md:p-12 text-white shadow-2xl relative overflow-hidden group">
              ...
              <h4 className="text-3xl font-bold mb-4 font-serif">林青穎 博士</h4>
              <div className="flex items-center gap-2 text-blue-200 text-sm mb-8 italic">
                <Briefcase className="w-4 h-4" /> 國立屏東大學 計畫主持人
              </div>
              <p className="text-blue-100 text-sm leading-relaxed mb-10 opacity-80">
                主導整體「AI Di+」研究架構、資源整合及校際合作。致力於將先進 AI 應用導入偏鄉英語及跨域學習，推動「大學伴」與「小學伴」之優質數位互動模組。
              </p>
              <a href="mailto:genie8451@mail.moe.gov.tw" className="inline-flex items-center gap-3 bg-white/10 hover:bg-white/20 px-6 py-3 rounded-full text-xs font-bold transition-all backdrop-blur-sm">
          ...
          <div className="lg:col-span-7 space-y-6">
            <div className="bg-white rounded-[2rem] p-8 shadow-xl border border-slate-100">
              ...
              <div className="space-y-4">
                {[
                  { name: "專任助理 A", role: "行政管理及媒合對接", detail: "負責國民中小學學習端媒合、計畫進度追蹤與行政彙整。" },
                  { name: "專任助理 B", role: "技術支援及數位平台", detail: "負責因材網帳號綁定、數位平台操作疑難排解與維護。" }
                ].map((assistant, i) => (
